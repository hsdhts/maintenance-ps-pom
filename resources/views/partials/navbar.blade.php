...
{{-- 
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                    ...
                    <div class="menu-item">
                        <a class="menu-link py-3" href="/pelumas" title="Daftar semua spareparts"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a class="menu-link py-3" href="/protocol" title="Daftar semua spareparts"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <span class="menu-icon">
            ...
            <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                ...
                <div
                    ...
                    <div class="menu-item">
                        <a class="menu-link py-3" href="/kategori" title="Daftar semua kategori mesin"
                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                            data-bs-placement="right">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
